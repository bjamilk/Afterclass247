...
import { Group, AppMode, User } from '../types';
import GroupListItem from './GroupListItem';
import { PlusIcon, ChartBarIcon, UsersIcon, CameraIcon, SunIcon, MoonIcon, CloudArrowDownIcon, ArrowPathIcon, BellIcon, BuildingStorefrontIcon, ArrowLeftOnRectangleIcon, WalletIcon, ArchiveBoxIcon, ChevronDownIcon, ChevronRightIcon } from '@heroicons/react/24/outline';
        ...
        <div className="flex items-start justify-between mb-3">
            <div className="flex items-start min-w-0">
                ...
                <div className="min-w-0">
                    ...
                    <button onClick={onOpenWalletModal} className="group flex items-center text-xs text-green-400 dark:text-green-300 hover:text-green-300 dark:hover:text-green-200">
                        <WalletIcon className="w-4 h-4 mr-1 text-green-500 dark:text-green-400 group-hover:text-green-400 dark:group-hover:text-green-300"/>
